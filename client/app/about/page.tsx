    ...
    <div className="min-h-screen bg-dark">
      ...
      <main className="py-12">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">About FARAS</h1>
            <p className="text-xl text-gray-400">Building strength, fueling performance</p>
          </motion.div>
            ...
            >
              ...
              <ul className="space-y-3 text-lg">
                <li className="flex items-start gap-3">
                  ...
                  <span><strong className="text-white">Science-Backed:</strong> Every product is formulated based on the latest research and proven ingredients.</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-primary mt-1">✓</span>
                  <span><strong className="text-white">Quality First:</strong> We never compromise on purity, potency, or quality.</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-primary mt-1">✓</span>
                  <span><strong className="text-white">Transparency:</strong> We believe in complete transparency about our ingredients and processes.</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-primary mt-1">✓</span>
                  <span><strong className="text-white">Athlete Focused:</strong> Designed by athletes, for athletes.</span>
                </li>
              </ul>
            </motion.section>
