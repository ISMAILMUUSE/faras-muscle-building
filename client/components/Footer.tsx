    ...
    <footer className="bg-dark border-t border-dark-lighter">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Brand */}
          <div>
            <h3 className="text-2xl font-bold text-primary mb-4">FARAS</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/why-faras" className="text-gray-400 hover:text-primary transition-colors">
                  Why FARAS
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/shipping-policy" className="text-gray-400 hover:text-primary transition-colors">
                  Shipping Policy
                </Link>
              </li>
            </ul>
